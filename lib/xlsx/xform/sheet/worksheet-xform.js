...
utils.inherits(
  ...
  },
  {
    ...
    parseClose(name) {
      ...
      switch (name) {
        case 'worksheet':
          properties = this.map.sheetFormatPr.model;
          ...
          pageSetup = Object.assign(sheetProperties, this.map.pageSetup.model, this.map.printOptions.model);
          this.model = {
          ...
          if (
            this.map.headerFooter.model &&
            (this.map.headerFooter.model.header.odd ||
              this.map.headerFooter.model.footer.odd)
          ) {
